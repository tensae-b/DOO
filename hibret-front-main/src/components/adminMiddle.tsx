  ...
  return (
    ...
    <div className="flex  flex-col w-60 h-48 top-64 left-96 rounded-md border border-gray-200 bg-white p-6">
      ...
      <div className="flex flex-col">
        ...
        >
          <path
            d="M181.592 40.0813C181.592 40.0813 171.67 27.3569 155.278 27.3569C141.452 27.3569 136.085 42.5283 124.058 42.5283C107.556 42.5283 107.556 17.0795 90.162 17.0795C74.998 17.0795 69.1475 49.3799 46.454 49.3799C22.816 49.3799 28.2155 13.1643 1.40804 13.1643"
            stroke="#F97066"
            stroke-width="1.784"
...
<path d="M1.30151 22.4336C1.30151 22.4336 11.2116 35.1737 27.5833 35.1737C41.3924 35.1737 46.753 29.7836 58.7651 29.7836C75.247 29.7836 75.247 48.4037 92.6197 48.4037C107.765 48.4037 113.609 31.7436 136.274 31.7436C159.883 31.7436 154.49 1.36365 181.265 1.36365" stroke="#32D583" stroke-width="1.78182" stroke-linecap="round"/>
</svg>
