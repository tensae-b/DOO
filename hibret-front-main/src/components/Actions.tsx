...
const Actions = (workflowId: any, currentStage: any) => {
  ...
  return (
    <div className="h-96 w-80 border border-gray-500 border-opacity-10 my-9 flex flex-col p-4 gap-4 items-center">
      ...
      href={`/EditDocument/${workflowId.workflowId}/0`}
            className="w-44 h-9 flex justify-center items-center border border-teal-500 rounded-md text-teal-500 text-sm px-5"
