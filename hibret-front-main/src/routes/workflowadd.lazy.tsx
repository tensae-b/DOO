...
function WorkFlowAddTemp() {
  const [stageCondition, setStageCondition] = useState(false);
  const {
    register,
    handleSubmit,
    watch,
                          ...
                          <div className="flex gap-5 w-full">
                            <div className="flex gap-4 justify-center items-center ">
                              <input
                                ...
                                name="stageCondition"
                                onChange={(e) => {
                                  setStageCondition(e.target.checked);
                                }}
                              />
                              <label
                                htmlFor="additionalInfo"
                          ...
                          >
                            ...
                            <div className="flex flex-row items-start justify-center w-full border border-[#EFEFF4] rounded-lg">
                              <select
                                ...
                                {...register(`sections.${index}.operator`)}
                              >
                              ...
                              <input
                                type="text"
                                {...register(`sections.${index}.condition`, {
                                  required: true,
                                })}
                            ...
                            <div className="w-full flex flex-col gap-2">
                              ...
                              <select
                                {...register(`sections.${index}.department`)}
